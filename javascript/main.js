const arr = [
  {
    ...
    live: 'https://www.afroeat.com/',
    source: 'https://github.com/chrisafroeat/Afroeat_frontend.git',
    tech: [ 'React','Next','Node','PostgreSQL','Vercel','Render','Software Engineer'],
  },
  {
    id: 2,
    imageDesk: 'img/Electrical.png',
    imageMob: 'img/Electrical.png',
    title: 'Top PPE And Electrical Store',
    description: 'Developed a secure inventory management system to keep track of business records using Next.js, TypeScript, Tailwind, and PostgreSQL.',
    live: 'https://www.topppeandelectricalstore.com/',
    source: 'https://github.com/CollinsTatang/inventory.git',
    tech: ['React',' Next','PostgreSQL','Vercel','Render','Software Engineer'],
  },
